          ...
          <div class="row justify-content-center">
            <div class="col-md-11">
              ...
              <div class="row row-cols-2 row-cols-md-auto gx-0 justify-content-center">
                ...
                <div class="col text-center">
                  <a href="/tong-quan/chuoi-gia-tri"> <img class="img-b10w" src="/static-assets/dist/temp/1-2.png" alt=""> </a>
                </div>
                <div class="col text-center">
                  <a href="/tong-quan/chuoi-gia-tri"> <img class="img-b10w" src="/static-assets/dist/temp/1-4.png" alt=""> </a>
                </div>
                <div class="col text-center">
                  <a href="/tong-quan/chuoi-gia-tri"> <img class="img-b10w" src="/static-assets/dist/temp/1-3.png" alt=""> </a>
                </div>
                <div class="col text-center">
                  <a href="/tong-quan/chuoi-gia-tri"> <img class="img-b10w" src="/static-assets/dist/temp/1-5.png" alt=""> </a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="hof-mf py-3 pt-md-5">
          ...
          <div class="row mb-5">
            ...
            <div class="col-md-6" style="text-align: justify;display: flex;flex-direction: column;justify-content: space-between; font-size: 15px;">
              ...
              <div class="view-more">
                <a class="d-flex align-items-center" href="/tong-quan/lich-su">
