...
class EnPromotionSearchHelper{
    static final String NEWS_CONTENT_TYPE ="content-type:\"/page/enpagetailieukm\" "
    ...
    EnPromotionSearchHelper(elasticsearch, UrlTransformationService urlTransformationService) {
        this.elasticsearch = elasticsearch
        this.urlTransformationService = urlTransformationService
    }
    
    def searchEnPromotion(categories, start = DEFAULT_START, rows = DEFAULT_ROWS, additionalCriteria = null){
